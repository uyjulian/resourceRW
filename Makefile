...
CFLAGS += -Wall -Wno-unused-value -Wno-format -fpermissive -I. -I.. -I../ncbind -I../00_simplebinder -DGIT_TAG=L\"$(GIT_TAG)\" -DNDEBUG -DWIN32 -D_WIN32 -D_WINDOWS 
...
SOURCES := ../tp_stub.cpp ../00_simplebinder/v2link.cpp Main.cpp
OBJECTS := $(SOURCES:.c=.o)
OBJECTS := $(OBJECTS:.cpp=.o)

BINARY ?= ResourceRW.dll
ARCHIVE ?= ResourceRW.$(GIT_TAG).7z
